...
{
    public static class Spanish_Transform_Numbers_To_Letters
    {
        //Cifra mas alta traducida 999,999,999,999

        public static void Tranform_And_Show_In_The_Console_The_Result()//------------------------------console---------------------
        {
                        string resultado = "";//varible que almacenara el resultado
            Console.Write("Escriba la cantidad a transformar (El valor maximo a transformado es 999,999,999,999 no digite un numero mayor): ");
            ...
            {
                Console.WriteLine("Losentimos el numero digitado no tiene el formato correcto para ser transformado");
            }

            Console.Clear();
            Console.Write("El resultado de transformar el valor '{0}' a letras es, '{1}'",input, Tranform_And_Return_The_Value_As_String(input));//muestr el resultado
            Console.ReadKey();//no eja que la consola se cierre
        }//-------------------------------------------------------------------------------end console----------------------------------

        public static string Tranform_And_Return_The_Value_As_String(string input)//-----------------------------return string--------------
        {
        ...
        //inglish
        private static string[] units = new string[]//representa la unidades 0-9
        {
            "zero","one","two","three","four","five","six","seven","eight","nine",
        };

        private static string[] Tens = new string[]//representa las decenas 10-90
        {
        ...
        private static string[] Hundreds = new string[]//representa las centenas 100-900
        {
        ...
        {
               "zero","cien","dociento ","treciento ","cuatrociento ","Quiniento ","seiciento ","seteciento ","ochociento ","noveciento "
        };
        //end spanish
        ...
        private static string ProcesarTresDigitos(string input)//funcion principal que devuelve l transformacion de un numero de tres digitos
        {
            ...
            return resultado;//return el resultado
        }
    }
}
